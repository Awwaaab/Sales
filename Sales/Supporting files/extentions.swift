...
extension UIViewController {
    func showAlertController(alerTitle : String , alertMessage : String , alertPreferredStyle:UIAlertController.Style ,alertActionTitle : String , alertActoinStyle : UIAlertAction.Style,handler: ((UIAlertAction) -> Void)? = nil){
